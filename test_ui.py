...
# Тест для проверки действий на странице "About":
...
def test_about_page(browsser):
    ...
    time.sleep(3)
    assert testpage.get_element_text_about() == "About Page"
    time.sleep(3)
    assert testpage.get_element_font_size(
        TestSearchLocators.ids["LOCATOR_ABOUT_PAGE_HEADER"]) == "32px"
