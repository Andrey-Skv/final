...
class OperationHelper(BasePage):
    ...
    def enter_pass(self, word):
        self.enter_text_into_field(
            TestSearchLocators.ids["LOCATOR_PASS_FIELD"], word, description="pasword form")
    ...
    def enter_description(self, word):
        self.enter_text_into_field(
            TestSearchLocators.ids["LOCATOR_DESCRIPTION"], word, description="description form")
    ...
    def enter_contact_name(self, word):
        self.enter_text_into_field(
            TestSearchLocators.ids["LOCATOR_CONTACT_NAME"], word, description="contact name form")
    ...
    def click_save_btn(self):
        self.click_button(
            TestSearchLocators.ids["LOCATOR_SAVE_BTN"], description="save")
    ...
    def click_contact_send_btn(self):
        self.click_button(
            TestSearchLocators.ids["LOCATOR_CONTACT_SEND"], description="contact us")

    def click_about_link(self):
        self.click_button(
            TestSearchLocators.ids["LOCATOR_ABOUT_LINK"], description="about")
    ...
    def get_element_text_about(self):
        return self.get_text_from_element(TestSearchLocators.ids["LOCATOR_ABOUT_PAGE_HEADER"], description="header")
